...
$pergunta_postada = new pergunta();
$lista = $pergunta_postada->listar_pergunta_postada();
...
else
{
    ...
    WHERE status_pergunta = 'RES' ORDER BY id_pergunta DESC ";
}
...
<body> 
    ...
    <script src="../scripts/script_publicada.js"> </script>
